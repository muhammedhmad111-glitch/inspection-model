-- Everything the weekly report and its video need, in one round trip. Doing this
-- client-side would be a dozen queries and would still leave the week-over-week
-- comparison to be stitched together in the browser.
